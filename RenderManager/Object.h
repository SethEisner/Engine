...
// 	const uint32_t m_sub_mesh_count;
...
// 	// }
// 	Object(uint32_t mesh_count) : m_sub_mesh_count(mesh_count){
// 		m_sub_mesh = new SubMesh[m_sub_mesh_count];
// 
// 	}
// 	~Object() {
// 		if(m_sub_mesh_count > 0) delete[] m_sub_mesh;
// 	}
// };
